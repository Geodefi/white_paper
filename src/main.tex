...
\subsubsection{ICO}
An ICO will start with the testnet launch and continue until the Mainnet launch.
Minimum 25\% of the requested amount needs to be invested, as this will be seen as the
first approval of the community. The collected budget will be used to improve the Geode
Finance with multiple Audits.
